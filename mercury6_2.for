...
c%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
c
c Author: John C. Moriarty
c
c Calculates Keplerian a and e given relative coordinates and
c velocities, and GM = G times the sum of the masses.
c
c The elements are: a = semi-major axis
c                   e = eccentricity
c
c------------------------------------------------------------------------------
c
      subroutine x2ae (gm,x,y,z,u,v,w,a,e)
c
      implicit none
      include 'mercury.inc'
c
c Input/Output
      real*8 gm,a,e,x,y,z,u,v,w
c
c Local
      real*8 hx,hy,hz,h2,v2,r,s
      real*8 temp
c
c------------------------------------------------------------------------------
c
...
c Local
      integer j
      real*8 taue, taued, taues, taum, taui, scaleH, ecc, sma, gm
c
c------------------------------------------------------------------------------
c
      a(1,1) = 0.d0
      ...
      do j = 2, nbod
        gm = m(1) + m(j)
        call x2ae(gm,x(1,j),x(2,j),x(3,j),v(1,j),v(2,j),v(3,j),sma,ecc) 
        print *, sma, ecc 
        a(1,j) = 0.d0
        a(2,j) = 0.d0
        a(3,j) = 0.d0
